...
namespace AzureSql.Database;

public partial class AzureCourseDbContext : DbContext
{
    public AzureCourseDbContext()
    {
    }

    public AzureCourseDbContext(DbContextOptions<AzureCourseDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECA2D8BC4E7");
